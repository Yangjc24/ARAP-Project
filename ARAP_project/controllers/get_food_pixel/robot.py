    ...
    def get_camera_image(self, interval=5):
        try:
            ...
            if self.camera_interval >= interval:
                ...
                #foodRGB betwwen R73-155 G175-196 B106-143
                ...
                for i in range(height):
                    for j in range(width):
                        ...
                        if ((red > 10) and (green > 10) and (blue > 10)):
                            if red < self.minRed:
                                self.minRed = red
                            if green < self.minGreen:
                                self.minGreen = green
                            if blue < self.minBlue:
                                self.minBlue = blue
                ...
                """for i in range(height):
                    for j in range(left_window):
                        ...
                        green = filteredimage[i, j, 1]
                        red = filteredimage[i, j, 2]
                        if ((red >= 73 and red <= 155) and (green >= 175 and green <= 196) and (blue >= 106 and blue <= 143)):
                            self.food_left += 1
        ...
        print("minRGB :", self.minRed, self.minGreen, self.minBlue)
        print("maxRGB :", self.maxRed, self.maxGreen, self.maxBlue)
